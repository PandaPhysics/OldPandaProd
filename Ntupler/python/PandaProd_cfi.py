...
PandaNtupler = cms.EDAnalyzer("Ntupler",
    ...
    phoLooseIdMap  = cms.InputTag("egmPhotonIDs:cutBasedPhotonID-Spring16-%(bx)s-%(vs)s-loose"),
    phoMediumIdMap = cms.InputTag("egmPhotonIDs:cutBasedPhotonID-Spring16-%(bx)s-%(vs)s-medium"),
    phoTightIdMap  = cms.InputTag("egmPhotonIDs:cutBasedPhotonID-Spring16-%(bx)s-%(vs)s-tight"),
