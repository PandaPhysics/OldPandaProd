...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:/tmp/mcremone/30F60D71-0626-E611-ADA0-003048F5ADEC.root'),
...
process.ak4GenJetsYesNu = cms.EDProducer("FastjetJetProducer",
    Active_Area_Repeats = cms.int32(5),
    GhostArea = cms.double(0.01),
    Ghost_EtaMax = cms.double(6.0),
    Rho_EtaMax = cms.double(4.5),
...
process.puppiMETcorr = cms.EDProducer("PFJetMETcorrInputProducer",
    jetCorrEtaMax = cms.double(9.9),
    jetCorrLabel = cms.InputTag("ak4PuppiCorrector"),
...
process.patMetModuleSequence = cms.Sequence(process.pfMet+process.genMetExtractor+process.patJetCorrFactorsReapplyJEC+process.patJetsReapplyJEC+process.basicJetsForMet+process.jetSelectorForMet+process.cleanedPatJets+process.patPFMet+process.metrawCalo)
...
process.puppiCA15Sequence = cms.Sequence(process.genJetsNoNuCA15+process.genJetsNoNuSoftDropCA15+process.PFJetspuppiCA15+process.PFJetsSoftDroppuppiCA15+process.puppiCA15SDKinematics+process.puppiCA15Njettiness+process.puppiCA15SubQGTag+process.puppiCA15PFImpactParameterTagInfos+process.puppiCA15PFInclusiveSecondaryVertexFinderTagInfos+process.puppiCA15PFCombinedInclusiveSecondaryVertexV2BJetTags+process.puppiCA15PFImpactParameterDoubleSVTagInfos+process.puppiCA15PFInclusiveSecondaryVertexFinderDoubleSVTagInfos+process.puppiCA15PFBoostedDoubleSVTagInfos+process.puppiCA15PFBoostedDoubleSecondaryVertexBJetTags+process.patJetPartonMatchPFpuppiCA15+process.patJetGenJetMatchPFpuppiCA15+process.patJetsPFpuppiCA15+process.selectedPatJetsPFpuppiCA15+process.patJetPartonMatchSoftDropPFpuppiCA15+process.patJetGenJetMatchSoftDropPFpuppiCA15+process.patJetsSoftDropPFpuppiCA15+process.selectedPatJetsSoftDropPFpuppiCA15+process.patJetPartonMatchSoftDropSubjetsPFpuppiCA15+process.patJetGenJetMatchSoftDropSubjetsPFpuppiCA15+process.patJetsSoftDropSubjetsPFpuppiCA15+process.selectedPatJetsSoftDropSubjetsPFpuppiCA15+(process.selectedPatJetsSoftDropPFPackedpuppiCA15+process.packedPatJetsPFpuppiCA15))
...
process.puppiAK8Sequence = cms.Sequence(process.genJetsNoNuAK8+process.genJetsNoNuSoftDropAK8+process.PFJetspuppiAK8+process.PFJetsSoftDroppuppiAK8+process.puppiAK8SDKinematics+process.puppiAK8Njettiness+process.puppiAK8SubQGTag+process.puppiAK8PFImpactParameterTagInfos+process.puppiAK8PFInclusiveSecondaryVertexFinderTagInfos+process.puppiAK8PFCombinedInclusiveSecondaryVertexV2BJetTags+process.puppiAK8PFImpactParameterDoubleSVTagInfos+process.puppiAK8PFInclusiveSecondaryVertexFinderDoubleSVTagInfos+process.puppiAK8PFBoostedDoubleSVTagInfos+process.puppiAK8PFBoostedDoubleSecondaryVertexBJetTags+process.patJetPartonMatchPFpuppiAK8+process.patJetGenJetMatchPFpuppiAK8+process.patJetsPFpuppiAK8+process.selectedPatJetsPFpuppiAK8+process.patJetPartonMatchSoftDropPFpuppiAK8+process.patJetGenJetMatchSoftDropPFpuppiAK8+process.patJetsSoftDropPFpuppiAK8+process.selectedPatJetsSoftDropPFpuppiAK8+process.patJetPartonMatchSoftDropSubjetsPFpuppiAK8+process.patJetGenJetMatchSoftDropSubjetsPFpuppiAK8+process.patJetsSoftDropSubjetsPFpuppiAK8+process.selectedPatJetsSoftDropSubjetsPFpuppiAK8+(process.selectedPatJetsSoftDropPFPackedpuppiAK8+process.packedPatJetsPFpuppiAK8))
...
process.puppiJetMETSequence = cms.Sequence(process.ak4PFJetsPuppi+process.packedGenParticlesForJetsNoNu+process.ak4GenJetsNoNu+process.patJetPartonMatchPFAK4Puppi+process.patJetGenJetMatchPFAK4Puppi+process.pfImpactParameterTagInfosPFAK4Puppi+process.pfInclusiveSecondaryVertexFinderTagInfosPFAK4Puppi+process.pfCombinedInclusiveSecondaryVertexV2BJetTagsPFAK4Puppi+process.patJetsPFAK4Puppi+process.pfMETPuppi+process.ak4PuppiL1+process.ak4PuppiL2+process.ak4PuppiL3+process.ak4PuppiCorrector+process.puppiMETcorr+process.type1PuppiMET)
...
process.jec = cms.ESSource("PoolDBESSource",
    ...
    toGet = cms.VPSet(cms.PSet(
        ...
        tag = cms.string('JetCorrectorParametersCollection_Spring16_25nsV6_MC_AK4PFPuppi')
    ), 
        cms.PSet(
