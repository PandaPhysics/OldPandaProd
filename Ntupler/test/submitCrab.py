...
config.Data.outLFNDirBase = '/store/group/phys_exotica/monotop/pandaprod/v_8024_3/' 
...
config.Site.blacklist = ['T3_US_UCR','T3_TW_NTU_HEP','T3_US_UMiss','T2_EE_Estonia','T2_US_Vanderbilt']
