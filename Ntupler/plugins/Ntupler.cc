...

{
    ...
    if (iConfig.getParameter<bool>("doCHSAK8")) {
      ...
      chsAK8->doubleb_token = mayConsume<reco::BoostedDoubleSVTagInfoCollection>(edm::InputTag("chsAK8boostedDoubleSVTagInfo","AK8PFBoostedDoubleSVTagInfosCHS") ) ;
    ...
    if (iConfig.getParameter<bool>("doPuppiAK8")) {
      ...
      puppiAK8->doubleb_token = mayConsume<reco::BoostedDoubleSVTagInfoCollection>(edm::InputTag("puppiAK8boostedDoubleSVTagInfo","AK8PFBoostedDoubleSVTagInfosCHS") ) ;
    ...
    if (iConfig.getParameter<bool>("doCHSCA15")) {
      ...
      chsCA15->doubleb_token = mayConsume<reco::BoostedDoubleSVTagInfoCollection>(edm::InputTag("chsCA15boostedDoubleSVTagInfo","AK8PFBoostedDoubleSVTagInfosCHS") ) ;
    ...
    if (iConfig.getParameter<bool>("doPuppiCA15")) {
      ...
      puppiCA15->doubleb_token = mayConsume<reco::BoostedDoubleSVTagInfoCollection>(edm::InputTag("puppiCA15boostedDoubleSVTagInfo","AK8PFBoostedDoubleSVTagInfosCHS") ) ;
